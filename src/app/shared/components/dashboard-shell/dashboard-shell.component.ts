...
import { AppointmentReminderNotifyService } from '../../services/appointment-reminder-notify.service';
...
export class DashboardShellComponent implements OnInit {
  ...
  constructor(
    ...
    readonly reminderNotify: AppointmentReminderNotifyService
  ) {
