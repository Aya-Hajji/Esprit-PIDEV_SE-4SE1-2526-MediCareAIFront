...
export class CollaborationService {
  private sessionUrl = `${environment.apiBaseUrl}/collaboration/sessions`;
  private documentUrl = `${environment.apiBaseUrl}/collaboration/documents`;
  private annotationUrl = `${environment.apiBaseUrl}/collaboration/annotations`;
  private meetingUrl = `${environment.apiBaseUrl}/meetings`;
