...
export class AuthService {
  ...
  getUserRole(): string {
    ...
    if (roleFromStorage) {
      return this.normalizeRole(roleFromStorage);
    }

    return this.normalizeRole(this.currentUserValue?.role);
  }
  ...
  getUserEmail(): string {
    return localStorage.getItem('userEmail') || this.currentUserValue?.email || '';
  }
